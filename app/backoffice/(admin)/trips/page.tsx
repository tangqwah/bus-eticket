  ...
  return (
    <div className="flex flex-col gap-4 max-w-[1200px]">
      ...
      <div className="bg-white rounded-2xl border border-[#e5e7eb] p-4 flex items-center gap-4">
        <div className="flex items-center gap-2 border border-[#d0d5dd] rounded-lg px-3 py-2 flex-1 max-w-xs focus-within:border-[#171b82] focus-within:ring-1 focus-within:ring-[#171b82] transition-colors">
